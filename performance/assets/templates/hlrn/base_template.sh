...
#SBATCH --job-name=$job_prefix$partitions
#SBATCH --output $job_prefix$partitions.log
...
command="/home/bemheinr/performance_test/rust_q_sim/target/release/mpi_qsim\
 ...
 --population-file /scratch/usr/bemheinr/performance_test/berlin-input/$population_file\
 --output-dir /scratch/usr/bemheinr/performance_test/output/base/$routing_case/output-$$SLURM_NTASKS\
