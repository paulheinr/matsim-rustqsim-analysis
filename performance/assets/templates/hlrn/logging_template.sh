...
command="/home/bemheinr/performance_test/rust_q_sim_perf_logging/target/release/mpi_qsim\
 ...
 --output-dir /home/bemheinr/performance_test/output/blocking_logging/$routing_case/output-$$SLURM_NTASKS\
